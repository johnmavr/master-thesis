...
model='DDPC1' # GIVE the name of the nuclear model: 'SEMF' or ...
...
filename='DDPC1_table.dat' # GIVE the filename of the nuclear mass table: 'FRDM2012_table.dat' or ..., or None for SEMF
extra_tabulation=['Z','N'] # GIVE what the header of file contains: (['Z','A'], if contains only Z and A in any order) or (['Z','N'], if contains only Z and N in any order) or (['Z','N','A'], if contains only Z, N and A in any order), or None for SEMF
