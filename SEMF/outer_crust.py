...
model='SEMF' # GIVE the name of the nuclear model: 'SEMF' or ...
tabulation='semf_be' # GIVE the tabular_form: 'semf_be' or 'be' or 'mass_excess'
Bstar=0 # GIVE a magnetic field in Bcr units (Bcr=4.414e13G): Bstar>1304 or Bstar=0
filename=None # GIVE the filename of the nuclear mass table: 'FRDM2012_table.dat' or ..., or None for SEMF
extra_tabulation=None # GIVE what the header of file contains: (['Z','A'], if contains only Z and A in any order) or (['Z','N'], if contains only Z and N in any order) or (['Z','N','A'], if contains only Z, N and A in any order), or None for SEMF
sepform=None # GIVE how the columns are saparated in the file: ' ' or '\\s+' or ',' or ..., or None for SEMF
