...
model='HFB31' # GIVE the name of the nuclear model: 'SEMF' or ...
...
filename='HFB31_table.dat' # GIVE the filename of the nuclear mass table: 'FRDM2012_table.dat' or ..., or None for SEMF
