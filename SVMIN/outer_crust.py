...
model='SVMIN' # GIVE the name of the nuclear model: 'SEMF' or ...
...
filename='SVMIN_table.dat' # GIVE the filename of the nuclear mass table: 'FRDM2012_table.dat' or ..., or None for SEMF
